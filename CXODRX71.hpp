...
//## Uses: <unnamed>%68B0B79A00C5;reusable::Token { -> F}
...
class DllExport TC57TransactionFile : public postingfile::ReportFile  //## Inherits: <unnamed>%6260E6A702FF
{
  ...
  private:
    ...
    //## Other Operations (specified)
      ...
      //## Operation: write_TCR4_PaymentTransaction1_MC%68B64F030275
      bool write_TCR4_PaymentTransaction1_MC (IF::FlatFile& hFlatFile);

      //## Operation: write_TCR4_PaymentTransaction0_MC%68E35F88000A
      bool write_TCR4_PaymentTransaction0_MC (IF::FlatFile& hFlatFile);

      //## Operation: write_TCR3_BusAppDetails_Visa%68B64F1C032E
      bool write_TCR3_BusAppDetails_Visa (IF::FlatFile& hFlatFile);

      //## Operation: write_TCR97_CommonMerchantData%68B64F29036C
